...
def get_args():
    ...
    parser.add_argument('--class_index_file', type=str, default="ucfTrainTestlist/classInd.txt", help='Path to class indeces file')
    parser.add_argument('--test_split', type=str, default="ucfTrainTestlist/testlist01.txt", help='Path to test split')
    ...
    parser.add_argument('--resnet_model', type=str, default='resnet18', help='ResNet backbone to use: resnet18, resnet34, etc.')
